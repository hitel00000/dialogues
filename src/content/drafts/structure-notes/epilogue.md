...
그리고 시간이 흘러, 지금은 내가 비슷한 일을 하고 있다. 범주론을 공부하고, 프로그래밍과 AI를 오가며 사고의 구조를 글로 정리하고 있다. 문득 그 선배가 떠올랐다. 그때는 보이지 않던 것이 이제는 보인다.
...
이 책은 그런 구조를 따라가며 시작했다. 그리고 마지막에 와서야 다시 처음의 질문으로 돌아온다.
