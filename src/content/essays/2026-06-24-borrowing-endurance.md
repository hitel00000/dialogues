...
그럼에도 관찰을 지속하는 과정에서 한 가지 희망적인 단서를 발견했다. 장애물의 정체는 지능의 결여가 아닌 '지구력'의 고갈였다. 소위 뛰어난 문제 해결자들 역시 단번에 해답을 제시하는 초월적인 통찰을 지닌 것이 아니었다. 그들의 차별성은 교착 상태에서 발생하는 긴장을 오랫동안 견디며, 끊임없이 가설을 세우고 실험을 반복하는 수행적 내구력에 존재했다.
...
AI가 가져온 본질적인 변화는 지능적 추론의 완전한 대행이 아니다. 사유 과정에서 요구되는 다중의 역할 중 일부를 기계에 안정적으로 위임할 수 있게 되었다는 사실이다. AI는 인간을 대신해 최종 판단을 내리지는 않지만, 인간이 한계에 도달하기 전에 피로하지 않은 상대역으로서 끝없는 가설 검증과 대안의 나열을 가능하게 만든다.
...
이러한 환경에서 발현되는 기묘한 자신감은 내재적 지능의 비약적인 상승에서 오는 것이 아니다. 다만 예전에는 인지 지구력의 조기 방전으로 인해 미처 도달하지 못했던 논리의 말단에, 이제는 지치지 않는 기계의 내구성을 빌려 수행한 무수한 파편적 시도들을 통해 도달할 수 있게 되었다는 감각에서 비롯된다. 결국 기술의 시대가 선사한 것은 초지능의 획득이라기보다, 사유의 지구력을 임대하여 연명할 수 있게 된 구조적 연장이다.
